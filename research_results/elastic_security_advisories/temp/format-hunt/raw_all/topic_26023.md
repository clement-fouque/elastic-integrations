suyograo | 2015-07-21 20:44:44 UTC | #1

Logstash 1.5.2 and prior versions are vulnerable to a SSL/TLS security issue called the [FREAK][1] attack. If you are using the Lumberjack input, FREAK allows an attacker to successfully implement a man in the middle attack, intercepting communication between the Logstash Forwarder agent and Logstash server. 
...
system | 2017-07-06 13:46:38 UTC | #2
